  ...
  return (
    <div className="min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 grid-pattern">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-teal-500 opacity-20 rounded-full blur-3xl animate-float"></div>
        <div
          className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-orange-500 opacity-15 rounded-full blur-3xl animate-float-delayed"
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-72 h-72 bg-blue-500 opacity-15 rounded-full blur-3xl animate-float"
      ...
      {/* Hero */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 relative overflow-hidden">
        {/* Additional floating elements in hero */}
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-blue-500 opacity-20 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-cyan-500 opacity-20 rounded-full blur-3xl animate-float-delayed"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 to-cyan-500/20 rounded-3xl blur-2xl animate-pulse"></div>
              <div className="card-premium relative bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/50 dark:to-cyan-950/50 overflow-hidden">
                <div className="aspect-video bg-gradient-accent/20 rounded-2xl flex items-center justify-center relative">
                  {/* Animated background elements */}
                  <div className="absolute top-0 left-0 w-32 h-32 bg-teal-500 rounded-full blur-3xl opacity-40 animate-float"></div>
                  <div className="absolute bottom-0 right-0 w-40 h-40 bg-cyan-500 rounded-full blur-3xl opacity-40 animate-float-delayed"></div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-blue-500 rounded-full blur-3xl opacity-30 animate-float" style={{ animationDelay: "1.5s" }}></div>
                  <BarChart3 className="w-20 h-20 text-primary/50 relative z-10" />
                </div>
              </div>
            </div>
          </div>
