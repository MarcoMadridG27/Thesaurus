  ...
  return (
    <div className="min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-warm opacity-10 rounded-full blur-3xl animate-pulse"
      ...
      <header className="sticky top-0 z-50 glass-morphism backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center shadow-lg shadow-teal-500/50">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth/signin">
              <Button
                variant="outline"
                className="rounded-lg bg-transparent border-primary text-primary hover:bg-primary/10"
              >
                Ingresar
              </Button>
            </Link>
            <Link href="/auth/signup">
              <Button className="button-vibrant rounded-lg">Registrarse</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 relative">
        <div className="text-center space-y-8 fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link href="/auth/signup">
              <Button className="button-vibrant rounded-xl px-8 py-3.5 text-lg h-auto flex items-center gap-2 glow-primary">
      ...
      {/* Features */}
      <section id="features" className="py-24 md:py-32 bg-white/50 dark:bg-slate-900/20 border-y border-border">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="card-elevated relative bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/50 dark:to-cyan-950/50">
      ...
      <section className="py-20 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card-elevated bg-gradient-accent text-white border-0 text-center py-16 md:py-20 glow-primary">
